...
const CharactersView = () => {
	...
	return (
		<div className="px-5 mt-12">
			...
			<div className="flex justify-start mt-5 flex-col shadow-md bg-red-500 rounded-md pt-3 pb-3 px-4">
				...
				{noteOpen && (
					<p className="mt-3 font-light leading-loose">
						Here you can manage your existing characters or create a
						new one.
					</p>
				)}
			</div>
			...
			<div className="characters container w-full mt-10">
				<AnimateGroup play>
					<div className="no-characters text-center">
						...
						>
							<button
								...
								className="mt-8 w-8/12 mr-5 rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-white"
							>
								Create One
							</button>
						</Animate>
